...
if __name__ == '__main__':
    ...
    plt.legend([b1[0], b2[0]], (u'err', u'BIC'))
    plt.title('err and bic for different variance types', fontsize=18)
    plt.show()
    ...
    plt.title('GMM tuning: covariance_type=%s' % types[optimal], fontsize=20)
    plt.grid()
    plt.show()
